...
class LiquibaseConfiguration(private val env: Environment) {
    ...
    fun liquibase(
        ...
        dataSourceProperties: DataSourceProperties
            ...
            // SpringLiquibaseUtil.createAsyncSpringLiquibase(this.env, executor, liquibaseDataSource.ifAvailable, liquibaseProperties, dataSource.ifUnique, dataSourceProperties)
            .apply {
