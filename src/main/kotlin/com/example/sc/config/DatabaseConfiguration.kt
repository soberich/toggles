...
@Configuration
@EnableJpaRepositories("com.example.sc.repository")
...
class DatabaseConfiguration(private val env: Environment) {
    ...
    @Bean
    fun classpathScanningPersistenceUnitPostProcessor(dataSource: DataSource): ClasspathScanningPersistenceUnitPostProcessor {
        return ClasspathScanningPersistenceUnitPostProcessor("com.example").apply { setMappingFileNamePattern("**/*orm.xml") }
    }
}
