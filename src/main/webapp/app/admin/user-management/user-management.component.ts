...
export default class ScUserManagementComponent extends mixins(AlertMixin) {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-featuresapp-alert'], {
          param: decodeURIComponent(res.headers['x-featuresapp-params'].replace(/\+/g, ' ')),
        });
