<template>
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">features</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>
        <b-navbar-toggle
        right
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/feature">
                        ...
                        <span v-text="$t('global.menu.entities.feature')">Feature</span>
                    </b-dropdown-item>
                    <span slot="button-content" class="navbar-dropdown-menu">
                    ...
                    <b-dropdown-item  to="/admin/sc-metrics" active-class="active">
                        <font-awesome-icon icon="tachometer-alt" />
                        <span v-text="$t('global.menu.admin.metrics')">Metrics</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/admin/sc-health" active-class="active">
                        <font-awesome-icon icon="heart" />
                        <span v-text="$t('global.menu.admin.health')">Health</span>
                    </b-dropdown-item>
                    <b-dropdown-item  to="/admin/sc-configuration" active-class="active">
