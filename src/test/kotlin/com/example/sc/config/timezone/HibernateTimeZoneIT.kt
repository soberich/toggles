package com.example.sc.config.timezone

import com.example.sc.FeaturesApp
import com.example.sc.repository.timezone.DateTimeWrapper
import com.example.sc.repository.timezone.DateTimeWrapperRepository
 ...
 */
@SpringBootTest(classes = [FeaturesApp::class])
class HibernateTimeZoneIT {
    ...
    private fun generateSqlRequest(fieldName: String, id: Long): String =
        format("SELECT %s FROM sc_date_time_wrapper where id=%d", fieldName, id)
